...
rectangle "Shop frontend" as SF
rectangle "Shop API" as SA
rectangle "CRM frontend" as CF
rectangle "CRM API" as CA
rectangle "MES frontend" as MF
rectangle "MES API" as MA
database "PostgreSQL" as PG
storage "S3" as S3
queue "RabbitMQ" as MQ
rectangle "Fluent Bit" as FB
database "OpenSearch" as OS
rectangle "OpenSearch Dashboards" as OD
rectangle "OpenSearch Alerting" as AL
rectangle "Канал команды\nи дежурный" as NT
...
CA ..> FB : JSON-логи
MA ..> FB : JSON-логи
PG ..> FB : технические логи
S3 ..> FB : аудит доступа
MQ ..> FB : события брокера
